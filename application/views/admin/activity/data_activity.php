                ...
                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($item->statusAct==0){echo "<b>Data On Review</b>";}elseif($item->statusAct==2){echo "<b>Data Rejected</b>";}else{echo "<b>Data Approved</b>";}?></td>
                            <?php 
                            if($item->statusAct==1){
                            ?>
                            <td>
