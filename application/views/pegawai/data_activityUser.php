...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>pegawai/activity_user/tambah_activity',
            method: 'post',
            data: {aksi:aksi},
        ...
        $('.edit').click(function(){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>pegawai/activity_user/edit_activity',
                method: 'post',
        ...
        $('.hapus').click(function(){
            ...
            var activity = $(this).attr("activity");
            $.ajax({
                url: '<?php echo base_url(); ?>pegawai/activity_user/hapus_activity',
                method: 'post',
                data: {id_activity:activity},
                success:function(data){
                    location.reload();
